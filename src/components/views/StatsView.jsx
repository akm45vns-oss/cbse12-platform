  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 32 }}>
        <h1 style={{ fontSize: "clamp(24px, 5vw, 32px)", fontWeight: 900, color: "#831843", margin: "0 0 8px", letterSpacing: "-0.02em" }}>
      ...
      <div style={{
        ...
        {[
          ...
          { emoji: "📚", label: "Sessions Completed", value: stats.completedSessions, color: "#ec4899" },
      ...
      {/* Session Summary */}
      <div style={{
        background: "linear-gradient(135deg, rgba(255,248,251,0.95), rgba(255,240,245,0.95))",
        border: "1.5px solid #fce7f3",
        borderRadius: 20,
        padding: 24,
        marginBottom: 32,
        ...
        <h3 style={{ fontSize: 16, fontWeight: 800, color: "#831843", margin: "0 0 16px", letterSpacing: "-0.01em" }}>
          📋 Session Summary
        </h3>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
          <div>
            ...
            <div style={{ fontSize: 28, fontWeight: 900, color: "#ec4899" }}>{stats.totalSessions}</div>
          </div>
          <div>
            <div style={{ fontSize: 12, color: "#9d174d", fontWeight: 700, marginBottom: 6, textTransform: "uppercase", letterSpacing: "0.08em" }}>
              Completed
        ...
        <div style={{ marginTop: 16, paddingTop: 16, borderTop: "1px solid #fce7f3" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
            <span style={{ fontSize: 13, fontWeight: 700, color: "#831843" }}>Completion Rate</span>
            ...
            subjectsArray.map(([subject, data]) => (
              <div key={subject} style={{
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                  ...
                  <div style={{ fontSize: 16, fontWeight: 900, color: "#ec4899" }}>
      ...
      {stats.lastSession && (
        <div style={{
          ...
          Last studied: <strong style={{ color: "#831843" }}>{stats.lastSession.subject} - {stats.lastSession.chapter}</strong> ({formatDuration(stats.lastSession.duration)})
        </div>
      )}
    </div>
  );
