                    ...
                    <>
                      <div>
                        ...
                        <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                          ...
                          <button onClick={() => setShowResetPassword(s => !s)} style={{ background: "rgba(0, 0, 0, 0.02)", border: "1px solid rgba(0, 0, 0, 0.08)", borderRadius: "12px", color: "#64748b", fontSize: "20px", cursor: "pointer", padding: "10px 12px", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "44px", minWidth: "44px", flexShrink: 0 }}>{showResetPassword ? "🙈" : "👁️"}</button>
                        </div>
                      </div>
                      <div>
                ...
                <>
                  ...
                  <div>
                    ...
                    <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                      ...
                      <button onClick={() => setShowPass(s => !s)} style={{ background: "rgba(0, 0, 0, 0.02)", border: "1px solid rgba(0, 0, 0, 0.08)", borderRadius: "12px", color: "#64748b", fontSize: "20px", cursor: "pointer", padding: "10px 12px", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "44px", minWidth: "44px", flexShrink: 0 }}>{showPass ? "🙈" : "👁️"}</button>
                    </div>
