...
4. For multiple-choice questions (MCQs), you MUST list each option on its own individual line. Never place options inline or on the same line as the question. For example:
   ...
   (C) x^2
   (D) 2
5. Keep the markup simple and clean using standard double asterisks for bolding (e.g. **Section A**).
6. Do NOT provide answers, solutions, hints, or answer keys.
7. Return the paper content directly without any introductory or concluding chat remarks.`;
